    ...
    providers: [
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$hash$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(credentials.password) !== user.password) return null;
    ...
    callbacks: {
        async jwt ({ token, user, trigger, session }) {
            ...
            if (user) {
                ...
                token.picture = user.image; // NextAuth pakai field 'picture' di dalam JWT
            }
        ...
        async session ({ session, token }) {
            if (session.user) {
                ...
                session.user.image = token.picture; // Balikin ke 'image' buat Frontend
            }
            return session;
        }
    },
...
"[project]/src/app/api/transactions/recent/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json([]); // Kembalikan array kosong jika error
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__c4b86085._.js.map